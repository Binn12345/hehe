            ...
            <form class="form-horizontal" action="{{route('admin.store')}}" method="POST">
                ...
                <div class="box-body">
                  <div class="col-xs-4">
                    ...
                    {{-- <div class="col-sm-10"> --}}   
                      <input class="form-control input-lg" type="text" name="lastname" placeholder="Lastname" value="{{ $stud-> lastname }}" >
                    {{-- </div> --}}
                  </div>
                  <div class="col-xs-4">
                    {{-- <label for="inputEmail3" class="col-sm-2 control-label">Email</label> --}}
                    {{-- <div class="col-sm-10"> --}}
                      <input class="form-control input-lg" type="text" name="firstname" placeholder="Firstname" value="{{ $stud-> firstname }}" >
                    {{--   --}}
                  </div>
                  <div class="col-xs-4">
                    {{-- <label for="inputEmail3" class="col-sm-2 control-label">Email</label> --}}
                    {{-- <div class="col-sm-10"> --}}
                      <input class="form-control input-lg" type="text" name="middlemname" placeholder="Middlename / Optional" value="{{ $stud-> middlename }}" >
                  {{--   --}}
                  </div>
                  
            
                  <div class="col-xs-12" style="margin-top: 10px; margin-bottom: 10px;">      
                    <textarea class="form-control" placeholder="Present Address" value="{{$stud-> address }}" name="add" ></textarea>
                  </div>
                  {{-- age based on datepicker --}}
                  <div class="col-xs-4">
                    {{-- <label for="inputEmail3" class="col-sm-2 control-label">Email</label> --}}
                    {{-- <div class="col-sm-10"> --}}
                      <input class="form-control input-lg" type="text" name="age" placeholder="99"  value="{{$stud-> age}}">
                  {{--   --}}
                  </div>
                  <div class="col-xs-4">
                    {{-- <label for="inputEmail3" class="col-sm-2 control-label">Email</label> --}}
                    {{-- <div class="col-sm-10"> --}}
                      ...
                      <input class="form-control input-lg" type="date" name="dobb" placeholder="Birthdate" value="{{$stud->Birthdate}}"style="font-family:'Courier New', Courier, monospace;">
                  {{--   --}}
                  </div>
