                      ...
                      <div class="box-body" style="display: none;">
                        ...
                        {{--   --}}
                          ...
                          <div class="col-xs-12" style="margin-top:10px;" hidden>
                            {{-- <label for="inputEmail3" class="col-sm-2 control-label">Email</label> --}}
                            {{-- <div class="col-sm-10"> --}}
                              <input class="form-control input-lg" type="text" name="role" value="admin" placeholder="Confirm Password" style="font-family:'Courier New', Courier, monospace;" required>
                            </div>
                      </div>
                      <!-- /.box-body -->
                    </div>
