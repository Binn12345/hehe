      ...
      <ul class="sidebar-menu person" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('student.sTable') }}"><i class="fa fa-circle-o"></i> Data</a></li>
        ...
        <li class="treeview">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a data-toggle="modal" data-target="#modal-CREATE" style="cursor: pointer"><i class="fa fa-circle-o"></i> Create An Account</a></li>
